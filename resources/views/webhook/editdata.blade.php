                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-xs-12 mb-3"> 
                                        ...
                                        <select onClick="myFunction()"  class="form-control has-error" name="segment" id="segment" required>
                                            <option value="1" @if($editdata->segment == 1) selected @endif>EQUITY</option>
                                            <option   onClick="myFunction()" id="fno" value="2" @if($editdata->segment == 2) selected @endif>F&O</option>
                                        </select>
                                    </div>
                                    <div id="indices" class="col-sm-4 col-md-4 col-xs-12 mb-3"> 
                                        ...
                                        <select  class="form-control has-error" name="indices" id="indicesOps">
                                            ...
                                            <option value="1" @if($editdata->indices == 1) selected @endif>BANKNIFTY</option>
                                            <option  id="fno" value="2" @if($editdata->indices == 2) selected @endif>NIFTY</option>
                                        </select>
                                    </div>    
                                    <div class="row">  
